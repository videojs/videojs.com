...
Our friends at <Link href="http://fastly.com" target="_blank">Fastly</Link> are nice enough to provide hosting for all the necessary files for Video.js on their content delivery network. Using these hosted files is probably the easiest way to get started using Video.js, you simply need to include the following links in your page.
...
For more advanced workflows, installing via <Link href="http://npmjs.com" target="_blank">npm</Link> is recommended
...
Before getting started, you'll need <Link href="https://nodejs.org/" target="_blank">Node.js</Link> installed. See <Link href="https://github.com/videojs/video.js/blob/master/CONTRIBUTING.md#contributing-code" target="_blank">CONTRIBUTING.md</Link> for more details.
...
<p>
  <Link href="https://codepen.io/heff/pen/EarCt" target="_blank">Video.js Skin Designer</Link>
</p>
...
<p>
  <Link to="/plugins">Video.js Plugins</Link>
</p>

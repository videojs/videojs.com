...
Our friends at <a href="http://fastly.com" target="_blank">Fastly</a> are nice enough to provide hosting for all the necessary files for Video.js on their content delivery network. Using these hosted files is probably the easiest way to get started using Video.js, you simply need to include the following links in your page.
...
For more advanced workflows, installing via <a href="http://npmjs.com" target="_blank">npm</a> is recommended
...
Before getting started, you'll need <a href="https://nodejs.org/" target="_blank">Node.js</a> installed. See <a href="https://github.com/videojs/video.js/blob/master/CONTRIBUTING.md#contributing-code" target="_blank">CONTRIBUTING.md</a> for more details.
...
<a href="https://codepen.io/heff/pen/EarCt" target="_blank">Video.js Skin Designer</a>
...
<a href="/plugins/" target="_blank">Video.js Plugins</a>

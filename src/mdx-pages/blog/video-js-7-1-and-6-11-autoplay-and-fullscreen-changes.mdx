...
It's been a while since the last release post. The <Link href="https://github.com/videojs/video.js/releases/tag/v7.1.0" target="_blank" rel="noopener noreferrer">7.1.0</Link> and <Link href="https://github.com/videojs/video.js/releases/tag/v6.11.0" target="_blank" rel="noopener noreferrer">6.11.0</Link> releases of Video.js are full of great features from contributors and maintainers.
...
- <Link href="https://github.com/DoomTay" target="_blank" rel="noopener noreferrer">@DoomTay</Link>
- <Link href="https://github.com/ayamamori" target="_blank" rel="noopener noreferrer">@ayamamori</Link>
- <Link href="https://github.com/edoardocavazza" target="_blank" rel="noopener noreferrer">@edoardocavazza</Link>
- <Link href="https://github.com/PrincipeSayan" target="_blank" rel="noopener noreferrer">@PrincipeSayan</Link>
- <Link href="https://github.com/bcdarius" target="_blank" rel="noopener noreferrer">@bcdarius</Link>
...
- <Link href="https://github.com/practual" target="_blank" rel="noopener noreferrer">@practual</Link>
- <Link href="https://github.com/Demivan" target="_blank" rel="noopener noreferrer">@Demivan</Link>

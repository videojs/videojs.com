...
> <p>Thanks <Link href="https://www.browserstack.com/" target="_blank" rel="noopener noreferrer">Browserstack</Link> for sponsoring browser-based testing for Video.js!</p>

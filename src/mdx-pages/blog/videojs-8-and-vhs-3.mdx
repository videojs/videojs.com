...
The [complete CHANGELOG is available](https://github.com/videojs/video.js/blob/v8.0.0/CHANGELOG.md), but here are some highlights:
...
The [complete CHANGELOG is available](https://github.com/videojs/http-streaming/blob/v3.0.0/CHANGELOG.md), but here are some highlights:
...
Overall, the minfied and gzipped size of VHS is **reduced by around 4%**. We will continue to look for ways to optimize the size of Video.js.

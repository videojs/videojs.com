...
* `handlePlayerBlur(component)` - Handles blur events on the player, storing the last focused component.
* `handlePlayerFocus()` - Resumes Spatial Navigation when the player gains focus.

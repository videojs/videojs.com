...
Errors like this, where `X` will vary, can be caused by transpilation breaking code that is used in web workers. See the [webpack guide][webpack] for details of how to prevent this.

[hosting-media]: #problems-when-hosting-media

[text-tracks]: /guides/text-tracks

[webpack]: /guides/webpack

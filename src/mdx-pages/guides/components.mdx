...
When the [`useSVGIcons`](/guides/options/#useSVGIcons) option is enabled on the player, icons can be added or replaced on any `Component` using the `setIcon` method.

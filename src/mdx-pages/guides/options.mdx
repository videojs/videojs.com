...
Icons are expected to be used inside of the player only. When using SVG icons, a `vjs-icon-placeholder` class must be included in the HTML element where the icon is displayed. For more info on customization of icons, see [Skins in Video.js][skins].

...
var PluginNavSection = _el$render$createClass.createClass({
  ...
  filterPlugins: function filterPlugins(event) {
    var filteredPlugins = this.props.plugins.filter(function (plugin) {
...
var VideoJS = _el$render$createClass.createClass({
  ...
  componentDidMount: function componentDidMount() {
    ...
    video.innerHTML = '<p class="vjs-no-js">' + 'To view this video please enable JavaScript, and consider upgrading' + 'to a web browser that ' + '<a href="http://videojs.com/html5-video-support/" target="_blank">' + 'supports HTML5 video</a></p>';
...
var PluginComponent = _el$render$createClass.createClass({
  ...
  handleSelectionChange: function handleSelectionChange(selectedPlugin) {
    this.setState({ selectedPlugin: selectedPlugin });
  },

  filterPlugins: function filterPlugins(filteredPlugins) {
    this.setState({
      selectedPlugin: 0,
